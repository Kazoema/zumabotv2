exports.wait = () => {
	return`*「 WAIT 」 SEDANG PROSES, TUNGGU +1 MENIT*`
}
...
exports.noregis = () => {
	return`*「 BELUM DAFTAR 」*\n\n*cara daftar ${prefix}daftar nama|umur* \n*contoh ${prefix}daftar Kazoema|16*`
}

exports.rediregis = () => {
	return`*「 SUDAH DAFTAR 」*\n\n*kamu sudah terdaftar di database bot, Jadi Jangan Daftar Lagi Ngentot*`
}
...
exports.wrongf = () => {
	return`*format salah/text kosong Nulis Yg bener Ngentot*`
}
